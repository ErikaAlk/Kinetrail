/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: d398b129d2282dad0ccbe2691c851572)
...
interface __BaseEnv_Env {
	...
	OWNER_ID: string;
	FITDAYS_HISTORY_START: string;
	ACCESS_OIDC_ISSUER: string;
	ACCESS_OIDC_AUTHORIZATION_ENDPOINT: string;
	ACCESS_OIDC_TOKEN_ENDPOINT: string;
	ACCESS_OIDC_JWKS_URL: string;
	ACCESS_CLIENT_ID: string;
	OWNER_OIDC_SUB: string;
	PROFILE_ALLOWLIST: string;
	PERIODIC_SYNC: string;
	HC_ACCEPT_AFTER: string;
	HC_PROFILE_REF: string;
	HC_HEIGHT_CM: string;
	SCALE_ACCEPT_AFTER: string;
	SCALE_WEIGHT_WINDOW_KG: string;
	SYNC_SCHEDULER: DurableObjectNamespace<import("./src/index").SyncScheduler>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SyncScheduler";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "OWNER_ID" | "FITDAYS_HISTORY_START" | "ACCESS_OIDC_ISSUER" | "ACCESS_OIDC_AUTHORIZATION_ENDPOINT" | "ACCESS_OIDC_TOKEN_ENDPOINT" | "ACCESS_OIDC_JWKS_URL" | "ACCESS_CLIENT_ID" | "OWNER_OIDC_SUB" | "PROFILE_ALLOWLIST" | "PERIODIC_SYNC" | "HC_ACCEPT_AFTER" | "HC_PROFILE_REF" | "HC_HEIGHT_CM" | "SCALE_ACCEPT_AFTER" | "SCALE_WEIGHT_WINDOW_KG">> {}
}
